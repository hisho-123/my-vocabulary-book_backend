...
| status code | 内容                                       |
|-------------|-------------------------------------------|
| 400         | 入力内容の不正（JSON形式エラー）           |
| 401         | 認証失敗（ユーザー不存在/パスワード不一致） |
| 500         | サーバーエラー（DB接続失敗など）           |

#### サインアップ(POST /register)

| status code | 内容                                |
|-------------|-------------------------------------|
| 400         | 入力内容の不正、ユーザー名が50文字超過 |
| 409         | ユーザー名が既に存在                |
| 500         | サーバーエラー                      |
...
| status code | 内容                                   |
|-------------|---------------------------------------|
| 400         | 入力内容の不正（空文字、必須項目なし） |
| 401         | トークンなし/トークン無効              |
| 422         | 単語帳タイトル/単語/翻訳が長すぎる     |
| 500         | サーバーエラー                         |
